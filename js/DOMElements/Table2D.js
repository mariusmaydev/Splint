...
class Table2D {
    constructor(parent, name, rows, cols){
        ...
        this.tableElement = new DOMElement(this.id + "TableMain", "table", this.mainElement);
    ...
    getHead(){
        let row = new DOMElement(this.id + "TableHead", "tr", this.tableElement);
    ...
    getData2Head(column){
        let dataEle = new DOMElement(this.id + "TableData_Head_" + column, "th", this.head);
    ...
    getRow(index = null){
        if(index != null){
            ...
            let row = new DOMElement(this.id + "TableRow_" + (this.rowElements.length-1), "tr", this.tableElement);
    ...
    getData(row, column){
        ...
        let dataEle = new DOMElement(this.id + "TableData_" + row + "_" + column, "td", this.rowElements[row]);
            dataEle.Class("Table2DData");
        return dataEle;
    }
}